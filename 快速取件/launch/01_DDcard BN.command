...
# 01_DDcard BN 專屬 launcher：Finder 雙擊後自動啟動 SPX 本機 HTTP Server（port 4175），
# 並以 Google Chrome 開啟快速取件 Viewer（item=01）。
...
readonly SPX_ITEM_URL="${SPX_VIEWER_URL}?item=01"
...
echo
echo "01_DDcard BN Viewer 已啟動：${SPX_ITEM_URL}"
